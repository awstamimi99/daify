(function () {
  ...
  content.innerHTML = `
    ...
    <div class="dash-card">
      <div class="dash-card-header"><div><h2>Recent security events</h2><p>Fed by the backend once Drupal's logging is connected — shown here as illustrative demo data.</p></div></div>
